...
try {
     ...
     * It automatically tries to fetch the relays where the pubkey is writing to.
     */
    $profile = new Profile();
     ...
     * These relays are considered as good relays to bootstrap and collect data from the known pubkey.
     */
